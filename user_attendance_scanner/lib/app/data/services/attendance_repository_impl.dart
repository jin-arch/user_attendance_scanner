...
import 'package:user_attendance_scanner/app/data/models/attendance_model.dart';
...
class AttendanceRepositoryImpl implements AttendanceRepository {
  ...
  Future<void> saveAttendance(Attendance attendance) async {
    try {
      ...
      // Background upload is handled by PendingUploadService automatically
      // No need to call syncAllPending here - it blocks the UI
      // PendingUploadService will flush pending records in the background
    } catch (e) {
