...
class RisingFadeParticle extends StatefulWidget {
  const RisingFadeParticle({
    super.key,
    required this.size,
  ...
  @override
  State<RisingFadeParticle> createState() => _RisingFadeParticleState();
}

class _RisingFadeParticleState extends State<RisingFadeParticle>
